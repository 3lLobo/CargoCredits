...
function Donut({ travel, month }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center -m-6 rounded-xl bg-no-repeat bg-contain  bg-opacity-25">
      <Image
        src="/treeCargo.svg"
        alt="treeCargo"
        width={200}
      ...
      />
      <div className=" w-full h-full rounded-xl z-0">
        <Doughnut
          data={data}
          redraw
          options={{
